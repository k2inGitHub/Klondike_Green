...
public:
    ...
    static vector<string> split(string str, char splitStr);
    
    static Vec2 getRandomPoint(const cocos2d::Rect& rect);
    
    static cocos2d::Size calculateFontSize(std::string text, float chartWidth, std::string fontName, float fontSize);
...
//    static std::string a2u(const  char *inbuf );
    ...
    static std::string jsonString(std::unordered_map<std::string, std::string>);
