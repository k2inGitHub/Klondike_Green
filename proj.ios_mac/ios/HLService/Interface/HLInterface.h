...
//是否启用海外接口
#define USE_OVERSEAS_AD (1)

/**
        统计          广告
 海外 Flurry 友盟   Google Facebook Unity Vungle HL
 国内 友盟          Google Mogo Unity Vungle HL
 */
...
@property(nonatomic,assign) int ctrl_fb_banner_switch;

@property(nonatomic,copy) NSString *ctrl_fb_banner_id;

@property(nonatomic,copy) NSString *ctrl_fb_pop_id;
...
@property(nonatomic,assign) int ctrl_fb_pop_switch;		//Facebook 插屏开关
...
@property(nonatomic,assign) int ctrl_unsafe_fb_pop_switch;		//Facebook 插屏开关
...
@property(nonatomic,assign) int ctrl_fb_pop_time;
...
@property(nonatomic,copy) NSString *flurry_key;

@property(nonatomic,copy) NSString *flyerDevKey;

@property(nonatomic,copy) NSString *flyerAppID;

@property(nonatomic,assign) BOOL firebase_Switch;
...
@property(nonatomic,assign) int itunes_is_forced;
...
@property (nonatomic, assign) int loading_fb_pop_switch;
...
@property (nonatomic, assign) int admob_pop_level;
@property (nonatomic, assign) int unityad_pop_level;
@property (nonatomic, assign) int vungle_pop_level;
@property (nonatomic, assign) int fb_pop_level;
@property (nonatomic, assign) int left_pop_level;

@property (nonatomic, assign) int ctrl_fb_repeat_time;
