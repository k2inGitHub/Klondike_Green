...
-(void)LoadData{
    ...
    self.ctrl_fb_banner_switch = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"ctrl_fb_banner_switch"];
    
    self.ctrl_fb_banner_id = [[NSUserDefaults standardUserDefaults] stringForKey:@"ctrl_fb_banner_id" defaultValue:@""];
    
    self.ctrl_fb_pop_id = [[NSUserDefaults standardUserDefaults] stringForKey:@"ctrl_fb_pop_id" defaultValue:@""];
    ...
    self.ctrl_fb_pop_switch = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"ctrl_fb_pop_switch"];
    ...
    self.ctrl_unsafe_fb_pop_switch = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"ctrl_unsafe_fb_pop_switch"];
    ...
    self.ctrl_fb_pop_time = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"ctrl_fb_pop_time"];
    ...
    self.flurry_key = [[NSUserDefaults standardUserDefaults] stringForKey:@"flurry_key" defaultValue:@""];
    
    self.flyerDevKey = [[NSUserDefaults standardUserDefaults] stringForKey:@"flyerDevKey" defaultValue:@""];
    self.flyerAppID = [[NSUserDefaults standardUserDefaults] stringForKey:@"flyerAppID" defaultValue:@""];
    
    self.firebase_Switch = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"firebase_Switch" defaultValue:@""];
    ...
    self.latest_version = [[NSUserDefaults standardUserDefaults] stringForKey:@"latest_version" defaultValue:@""];

    
    self.itunes_is_forced = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"itunes_is_forced"];
    ...
    self.loading_fb_pop_switch = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"loading_fb_pop_switch"];
    ...
    self.admob_pop_level = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"admob_pop_level"];
    self.unityad_pop_level = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"unityad_pop_level"];
    self.vungle_pop_level = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"vungle_pop_level"];
    self.fb_pop_level = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"fb_pop_level"];
    self.left_pop_level = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"left_pop_level"];
    
    self.ctrl_fb_repeat_time = (int)[[NSUserDefaults standardUserDefaults] integerForKey:@"ctrl_fb_repeat_time"];
...
-(void)FixData{
    ...
    if (self.ctrl_fb_repeat_time == 0) {
        self.ctrl_fb_repeat_time = 8;
    }
}
