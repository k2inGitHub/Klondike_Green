...
- (void)getAd{
    ...
    _testDevices = @[
                     ...
                     @"ff46c698f4a993b4924a1e016075f966",
                     ];
...
- (void)interstitialWillLeaveApplication:(GADInterstitial *)ad{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:HLInterstitialLeaveNotification object:nil userInfo:@{HLAdTypeKey : HLAdAdmob}];
}

- (void)adViewWillLeaveApplication:(GADBannerView *)bannerView{
    [[NSNotificationCenter defaultCenter] postNotificationName:HLBannerLeaveNotification object:nil userInfo:@{HLAdTypeKey : HLAdAdmob}];
}
